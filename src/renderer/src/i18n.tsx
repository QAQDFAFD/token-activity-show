...
const en = {
  localActivity: 'Activity on this Mac', todayNav: 'Today', settingsNav: 'Settings', localOnly: 'Data stays on this Mac', openFullClient: 'Open full activity', menuTitle: 'Today', appearance: 'Appearance', system: 'System', light: 'Light', dark: 'Dark', mainNavigation: 'Main navigation',
  todayActivity: "Today's activity", localStatistics: 'Local statistics', coveredUntil: 'Covered until {time}', refreshNow: 'Refresh', refreshing: 'Refreshing…', loadingToday: "Loading today's activity…", loadFailed: 'Unable to load activity', retry: 'Retry', refreshFailed: 'Refresh failed', preservedData: 'Last successful data is still shown.', refreshChanged: 'Refresh complete: {count} changes found.', refreshNoChange: 'Refresh complete: no changes found.', refreshUnsupported: 'Refresh complete: enabled source formats are not supported yet.', refreshSkipped: 'Refresh skipped because another refresh is running.', refreshPartial: 'Refresh incomplete: some sources could not be refreshed.',
